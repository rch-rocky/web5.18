            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button 
                onClick={() => {
                  ...
                  link.href = '/森熹产品手册.pdf';
                  link.download = '森熹产品手册.pdf';
                  link.click();
                }}
                className="bg-white border border-primary text-primary hover:bg-primary/5 px-6 py-2 rounded-button font-medium transition-colors"
              >
                下载产品手册
              </button>
            </div>
