...
const productCategories = [
  ...
  },
  {
    id: "chromatography",
    title: "色谱柱",
    description: "提供森熹橙、森熹红、森熹蓝三大系列色谱柱产品，满足不同分析需求。",
    image:"spz.png",
    subcategories: [
      {
        title: "森熹橙系列",
        products: [
          { name: "ZPC-C18", description: "采用高度单分散多孔硅胶微球作为基质，适用于分离酸性、碱性、中性等物质" },
          { name: "CAQ-C18", description: "采用新一代微流体技术制造，适用于亲水性和极性化合物" },
          { name: "CPR-C18", description: "适用于低pH条件，未封尾设计使硅羟基数量更多" },
          { name: "ZPC-C8", description: "以辛基碳链键合硅胶为固定相，适用于中等或低疏水性物质" },
          { name: "ZPC-NH2", description: "氨基丙基官能团键合，适用于正相、反相、离子交换或HILIC模式" },
          { name: "ZPC-SiO2", description: "以硅胶为基质，用于正相色谱分离非极性和中等极性化合物" }
        ]
      },
      {
        title: "森熹红系列",
        products: [
          { name: "RD-C18", description: "具有高稳定性、独特的官能团键合及小分子封尾技术" },
          { name: "AQ-C18", description: "专为亲水性和极性化合物设计，可在纯水条件下使用" },
          { name: "PR-C18", description: "采用无封尾技术，适合低pH和高温条件" },
          { name: "RD-C8", description: "适用于宽pH范围，保留能力弱于C18" },
          { name: "RD-C4", description: "键合丁基基团，疏水性适中" }
        ]
      },
      {
        title: "森熹蓝系列",
        products: [
          { name: "RX-C18", description: "采用有机硅胶杂化基质，具有优异的耐碱性" },
          { name: "RX-C8", description: "基于杂化硅胶技术，耐宽pH范围" },
          { name: "XY-C18", description: "针对生物分子优化，采用双封尾技术" },
          { name: "XY-Sugar-Ca", description: "专为糖类分析设计的钙型强阳离子交换柱" },
          { name: "XY-Sugar-H", description: "氢型阳离子交换柱，用于有机酸分析" }
        ]
      }
    ]
  },
